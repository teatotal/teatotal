...
Tcl 9, the `Thread` package for the pool (`tpool::`), and `jobloop` from this shelf, whose lifecycle class this module builds on (it brings `leash` with it). No Tk.
